...
<?php
	if($_POST){
		...
		$query ="INSERT INTO customer_address (customer,address1,address2,city,state,zipcode)
								VALUES ('$mysqli->insert_id','$address1','$address2','$city','$state','$zipcode')";
		//Run query
		$mysqli->query($query);
        ...
        <div class="col-lg-12">
		 ...
		 <form role="form" method="post" action="add_customer.php">
			...
			<div class="form-group">
				...
				<input name="address" type="text" class="form-control" placeholder="Enter Address 1">
			</div>
			<div class="form-group">
